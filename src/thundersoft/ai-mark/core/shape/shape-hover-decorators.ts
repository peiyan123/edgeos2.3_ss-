      ...
      this.canvasOperation((ctx: CanvasRenderingContext2D) => {
        ...
        if (this.shapeHover) {
          // if (this.shapeHoverBackground) {
            ...
            ctx.fill();//开始填充
            // 绘制成矩形
            ctx.fillRect(this.shapeHover.minX!, this.shapeHover.minY!, (this.shapeHover.maxX! - this.shapeHover.minX!), (this.shapeHover.maxY! - this.shapeHover.minY!));
            ctx.strokeRect(this.shapeHover.minX!, this.shapeHover.minY!, (this.shapeHover.maxX! - this.shapeHover.minX!), (this.shapeHover.maxY! - this.shapeHover.minY!));
            ctx.stroke();
          // } else {
            ctx.beginPath();
