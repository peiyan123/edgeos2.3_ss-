...
class timeSlider extends CommonUtils {
  ...
  initRootDomEvent() {
    ...
    this.rootDom.addEventListener('mouseup', (e) => {
      ...
      this.hander(this.presentSeconds, oldPresentSeconds);
  ...
  calCurPreseconds(x) {
    ...
    // TODO: lgj 不能让时间光标出现小于0的情况
    if (this.presentSeconds < 0) {
      this.presentSeconds = 0;
    }
  }
  /**
 * 获取长度
